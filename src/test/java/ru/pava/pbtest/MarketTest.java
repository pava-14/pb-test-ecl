...
import ru.pava.pbtest.data.Product;
import ru.pava.pbtest.pages.HomePage;
import ru.pava.pbtest.pages.TabletsPage;
...
public class MarketTest {
	...
	public void shouldFindProductByName() {
		...
		TabletsPage tabletsPage = homePage.openPageTablets().selectProductsByBrand(brandName).writeToLog(productCount);
